...
<head runat="server">
    ...
    <title>TP 6 - GRUPO 11 - Ejercicio 1</title>
    ...
    <form id="formularioEj01" runat="server">
        <div style="display: flex; flex-direction: column; gap: 20px;">
          <asp:GridView ID="gvProductos" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" AutoGenerateColumns="False" AllowPaging="True"
            ...
            AutoGenerateEditButton="True" OnRowEditing="gvProductos_RowEditing" OnRowCancelingEdit="gvProductos_RowCancelingEdit" OnRowUpdating="gvProductos_RowUpdating1">
                <Columns>
