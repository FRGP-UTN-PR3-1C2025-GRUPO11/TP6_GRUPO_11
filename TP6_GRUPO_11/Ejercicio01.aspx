    ...
    <form id="formularioEj01" runat="server">
        <div style="display: flex; flex-direction: column; gap: 20px;">
            ...
            <asp:GridView ID="gvProductos" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" AutoGenerateColumns="False" AllowPaging="True" 
                OnPageIndexChanging="gvProductos_PageIndexChanging" Style="margin-right: 0px" AutoGenerateDeleteButton="True" OnRowDeleting="gvProductos_RowDeleting" AutoGenerateEditButton="True" 
                OnSelectedIndexChanged="gvProductos_SelectedIndexChanged" OnRowEditing="gvProductos_RowEditing">
                <Columns>
